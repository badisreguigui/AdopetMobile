...
public class ServicePet {
            ...
            public void actionPerformed(NetworkEvent evt) {
                ...
                try {
                    ...
                    for (Map<String, Object> obj : list) {
                        ...
                        int vues = Integer.parseInt(obj.get("user_id").toString());
    ...
    public ArrayList<Pet> showListTop() 
    
    {
        ArrayList<Pet> listVeto = new ArrayList<>();
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/mobile/showTopViewed.php");
    ...
    public Pet showPet(int id)
    {
                ...
                try {
                    ...
                    for (Map<String, Object> obj : list) {
                        ...
                        ///Pediatre p = new Pediatre();
                         float id = Float.parseFloat(obj.get("id_pet").toString());
                         int vues = Integer.parseInt(obj.get("user_id").toString());
                         int like = Integer.parseInt(obj.get("zip").toString());
      ...
      public void UpdateVues(Pet p)
    {
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/mobile/updatevues.php?id="+p.getId_pet()+"&vues="+p.getUser_id());
      ...
      public void UpdateLikes(Pet p)
    {
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/mobile/updatelike.php?id="+p.getId_pet()+"&vues="+p.getZip());
