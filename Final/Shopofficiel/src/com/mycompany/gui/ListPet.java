...
public class ListPet {
    ...
    public ListPet(Resources res)  {
        ...
        //*******************Recuperer la liste de produit de la base***************************************************
           ...
           ArrayList<Pet> listtop=sv.showListTop();
           
           
        Label l2 = new Label("TOP VIEWED PETS");
        f.add(l2);
        ...
        //****************************les elements du containers********************************************************
           ...
           try {
               iv.setImage(Image.createImage("/"+ vv.getPet_image()).scaled(100, 100));
               ...
               Label l1=new Label("id: "+ vv.getId_pet());
             ...
             //  l1.getStyle().set(0xC40C0C);
               ...
               c1.add(iv);
               c1.add(c3);
               c3.add(new SpanLabel( vv.getName_pet()));
               c3.add(l1);
...
//                   });
               ...
               b.addActionListener(e -> {
                   //v.setUser_id(v.getUser_id() +1);
                   System.out.println("jwnefkwefjkwnefjlnwejkfnjwefnweun");
                   System.out.println(id);
                   System.out.println(vv.getUser_id());
                   //System.out.println(v.getZip());
                   vv.setUser_id(vv.getUser_id() + 1);
        ...
        Label l = new Label("ALL ADOPTION PETS");
        f.add(l);
