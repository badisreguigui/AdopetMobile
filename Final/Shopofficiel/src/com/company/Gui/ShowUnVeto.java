...
public class ShowUnVeto{
    ...
    public ShowUnVeto(int id) throws IOException  {
       ...
       SpanLabel l1=new SpanLabel("Email: "+v.getEmail());
       SpanLabel l2=new SpanLabel("Telephone: (+216) "+v.getTelephone());
       SpanLabel l3=new SpanLabel("Adresse: "+v.getRue()+ ", " +v.getVille()+", "+v.getGouvernorat());
      // SpanLabel l4=new SpanLabel("PARCOURS: "+v.getDescription());
